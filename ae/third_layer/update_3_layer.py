...
for no in range(1,30+1):
    feat_path = '/home/yjzhang/feat/feat_con_online_512_'+'%02d' %no +'.txt'
...
#            print np.shape(feat_input)
            ...
            # print loss_final
                ...
                if ((loss_final-min_)/(max_-min_)>=0):
                    ...
                    filename3 = 'summary_res_3.txt'
                    f3 = open(filename3,'a')
                    b = [0]
                    np.savetxt(f3,b,fmt="%d")
                    f3.close()
                filename2 = 'loss_res_3.txt'
                f2 = open(filename2,'a')
            ...
            for summary_iter in range(0,train_cnt):
                ...
                # save_file_ = '/home/yjzhang/feat/feat_obj_online_256_'+'%02d' %no +'.txt'
