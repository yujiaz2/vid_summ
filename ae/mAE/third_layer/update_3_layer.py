...
model_path = '/home/dingwen/meanMask/obj_cont/mAE/third_layer/obj_cont_3_layer.ckpt'
...
for no in range(1,30+1):
    feat_path = '/home/dingwen/meanMask/obj_cont/online_feat/feat_obj_cont_online_512_'+'%02d' %no +'.txt'
...
#                    f3.close()
            ...
            for summary_iter in range(0,train_cnt):
                ...
                save_file_ = '/home/dingwen/meanMask/obj_cont/online_feat/feat_obj_cont_online_256_'+'%02d' %no +'.txt'
