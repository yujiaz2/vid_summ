...
model_path = '/home/yjzhang/exp_feat/context_feat/second_layer/con_2_layer.ckpt'
...
for no in range(1,30+1):
    feat_path = '/home/yjzhang/feat/feat_con_online_1024_'+'%02d' %no +'.txt'
...
#            print np.shape(feat_input)
            ...
            for summary_iter in range(0,train_cnt):
                ...
                save_file_ = '/home/yjzhang/feat/feat_con_online_512_'+'%02d' %no +'.txt'
