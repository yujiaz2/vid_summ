function [superFrames,motion_magnitude_of] = summe_superframeSegmentation(imageList,FPS,Params,i,frameRange,motion_file)
...
% superframes (format: [startFrame, endFrame])
    ...
    Clip = load(['/Users/yujia/Desktop/online_test/clip/clip_' num2str(i,'%d') '.mat']);
    lastFrame = Clip.clip_new{2};
    ...
    if exist('motion_file','var') && exist('motion_file','file')
        ...
        % Compute motion
        [motion_magnitude,motion_magnitude_back]= summe_computeMotion(imageList,frameRange,FPS,Params,Clip);
